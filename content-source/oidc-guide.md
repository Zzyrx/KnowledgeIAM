...
/* ============================================ */
 ...
 .oidc-doc .doc-header h1 {
 font-size: 2.8em;
 color: #5C4EE5;
 margin-bottom: 15px;
 font-weight: 700;
 }
 .oidc-doc .doc-header .subtitle {
 font-size: 1.3em;
 color: #5E6C84;
 font-weight: 400;
 }
 .oidc-doc .doc-header .version-info {
 margin-top: 20px;
 font-size: 0.9em;
 color: #5E6C84;
 }
 ...
 .oidc-doc .toc a:hover {
 color: #5C4EE5;
 text-decoration: underline;
 }
 .oidc-doc .toc .toc-section {
 font-weight: 600;
 margin-top: 15px;
 margin-bottom: 8px;
 }
 .oidc-doc .toc .toc-subsection {
 padding-left: 20px;
 font-size: 0.95em;
 }
 ...
 .oidc-doc .info-box.note {
 background: #E6F4FF;
 border-left: 4px solid #00B8D9;
 }
 .oidc-doc .info-box.warning {
 background: #FFFAE6;
 border-left: 4px solid #FFAB00;
 }
 .oidc-doc .info-box.success {
 background: #E3FCEF;
 border-left: 4px solid #36B37E;
 }
 .oidc-doc .info-box.important {
 background: #FFEBE6;
 border-left: 4px solid #FF5630;
 }
 .oidc-doc .info-box-title {
 font-weight: 700;
 margin-bottom: 10px;
 }
 ...
 /* Syntax highlighting */
 .oidc-doc .xml-tag { color: #569CD6; }
 .oidc-doc .xml-attr { color: #9CDCFE; }
 .oidc-doc .xml-value { color: #CE9178; }
 .oidc-doc .xml-comment { color: #6A9955; }
 .oidc-doc .json-key { color: #9CDCFE; }
 .oidc-doc .json-string { color: #CE9178; }
 .oidc-doc .json-number { color: #B5CEA8; }
 .oidc-doc .json-comment { color: #6A9955; }
 .oidc-doc .http-method { color: #569CD6; font-weight: bold; }
 .oidc-doc .http-url { color: #CE9178; }
 .oidc-doc .http-header { color: #9CDCFE; }
 ...
 .oidc-doc tr:nth-child(even) {
 background: #F4F5F7;
 }
 .oidc-doc tr:hover {
 background: #E6E6FF;
 }
 .oidc-doc .comparison-table th {
 text-align: center;
 }
 .oidc-doc .comparison-table td:first-child {
 font-weight: 600;
 background: #F4F5F7;
 }

 /* Diagrams */
 .oidc-doc .diagram-container {
 background: #F4F5F7;
 border-radius: 12px;
 padding: 30px;
 margin: 30px 0;
 ...
 .oidc-doc .diagram-container svg {
 max-width: 100%;
 height: auto;
 }
 .oidc-doc .diagram-caption {
 margin-top: 15px;
 font-style: italic;
 color: #5E6C84;
 font-size: 0.95em;
 ...
 .oidc-doc .glossary-term dt {
 font-weight: 700;
 color: #5C4EE5;
 font-size: 1.1em;
 margin-bottom: 8px;
 }
 .oidc-doc .glossary-term dd {
 color: #172B4D;
 padding-left: 0;
 }
 ...
 .oidc-doc .component-grid {
 display: table;
 width: 100%;
 margin: 30px 0;
 }
 .oidc-doc .component-grid::after {
 content: "";
 display: table;
 clear: both;
 }
 .oidc-doc .component-card {
 float: left;
 width: 47%;
 ...
 .oidc-doc .component-card h4 {
 color: #5C4EE5;
 margin-top: 0;
 margin-bottom: 12px;
 font-size: 1.15em;
 }
 .oidc-doc .component-card p {
 margin-bottom: 0;
 font-size: 0.95em;
 }

 /* Section cards */
 .oidc-doc .binding-section,
 .oidc-doc .profile-section,
 .oidc-doc .flow-section {
 background: white;
 border: 1px solid #DFE1E6;
 border-radius: 10px;
 padding: 30px;
 ...
 .oidc-doc .binding-section h4,
 .oidc-doc .profile-section h4,
 .oidc-doc .flow-section h4 {
 color: #5C4EE5;
 ...
 .oidc-doc .process-steps {
 list-style: none;
 margin-left: 0;
 padding-left: 0;
 }
 .oidc-doc .process-steps li {
 position: relative;
 padding-left: 60px;
 margin-bottom: 25px;
 min-height: 45px;
 ...
 # 🔑 OpenID Connect
 OIDC - Protocole d'Authentification Moderne
Guide Complet pour Débutants
 ...
 - [1. Introduction à OIDC](#introduction)
 - [1.1 Qu'est-ce qu'OIDC ?](#quest-ce-que-oidc)
 - [1.2 OAuth 2.0 vs OIDC](#oauth-vs-oidc)
 - [1.3 Pourquoi utiliser OIDC ?](#pourquoi-oidc)
 - [2. Composants Principaux](#composants)
 - [2.1 OpenID Provider (OP)](#openid-provider)
 - [2.2 Relying Party (RP)](#relying-party)
 - [2.3 End User](#end-user)
 - [3. Tokens OIDC](#tokens)
 - [3.1 ID Token (JWT)](#id-token)
 - [3.2 Access Token](#access-token)
 - [3.3 Refresh Token](#refresh-token)
 - [4. Flux d'Authentification](#flows)
 - [4.1 Authorization Code Flow](#authorization-code)
 - [4.2 Authorization Code + PKCE](#authorization-code-pkce)
 - [4.3 Implicit Flow (déprécié)](#implicit-flow)
 - [4.4 Hybrid Flow](#hybrid-flow)
 - [4.5 Client Credentials](#client-credentials)
 - [5. Scopes et Claims](#scopes-claims)
 - [5.1 Scopes Standards](#standard-scopes)
 - [5.2 Claims Standards](#standard-claims)
 - [6. Endpoints OIDC](#endpoints)
 - [7. Discovery et Metadata](#discovery)
 - [8. Sécurité](#securite)
 - [9. OIDC vs SAML](#comparaison)
...
```
 ...
 ⚠️ Validation obligatoire de l'ID Token
...
```
 ...
 #### ⚠️ Implicit Flow - NE PLUS UTILISER
...
```
 ...
 ⚠️ Le scope openid est obligatoire
...
```
 ...
 | `HS256` | HMAC + SHA-256 | ⚠️ Symétrique - éviter si possible |
 ...
 **Documentation OpenID Connect - Guide Complet pour Débutants**
Version 1.0 | Janvier 2025


 Cette documentation fournit une compréhension approfondie du protocole OpenID Connect,
de ses composants, flows, et mécanismes de sécurité.


 Références : OpenID Connect Core 1.0 | OAuth 2.0 (RFC 6749) | JWT (RFC 7519) | PKCE (RFC 7636)